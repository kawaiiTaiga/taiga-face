...
EyeRender renderEye(
  ...
  float visibleMask = shape * lidMask;
  float interior = smoothstep(0.018, -0.040, eDist) * lidMask;
  float edgeBand = smoothstep(0.024, -0.004, eDist) - smoothstep(-0.010, -0.050, eDist);
  ...
  float glassEdge = exp(-28.0 * abs(eDist + 0.01)) * lidMask;
  ...
  eye.fill = fillField + edgeBand * 0.12 + innerReflect * 0.04;
